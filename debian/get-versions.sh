...
echo ${full_version} >${output_dir}/libprocess-cpp.full-version
echo ${major} >${output_dir}/libprocess-cpp.major-version
echo ${minor} >${output_dir}/libprocess-cpp.minor-version
echo ${micro} >${output_dir}/libprocess-cpp.micro-version
echo ${major_minor} >${output_dir}/libprocess-cpp.major-minor-version
echo ${soversion} >${output_dir}/libprocess-cpp.soversion
echo ${vivid_soversion} >${output_dir}/libprocess-cpp.vivid-soversion
